  ...
  select * from healthcare.fhir_healthcare_analytics_gold.patient_encounter_summary;
  ...
  FROM healthcare.fhir_healthcare_analytics_gold.patient_chronic_conditions;

  -- Example: Cost intensity score;
